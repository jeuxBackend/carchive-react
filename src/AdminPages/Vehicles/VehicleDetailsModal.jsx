...
const VehicleDetailsModal = ({
  ...
  const getExpiryStatus = (dateString) => {
    ...
    if (daysUntilExpiry < 0) {
      return {
        status: "expired",
        message: `Expired ${Math.abs(daysUntilExpiry)} day${
            ...
            <div className="p-6">
                      ...
                      vehicleData.image.map((img, index) => (
                        <div
                          ...
                          className={`aspect-video ${
                            theme === "dark" ? "bg-[#1b1c1e]" : "bg-gray-100"
              ...
              {hasOwnerInfo && (
                <div className="mb-6">
                  ...
                  <div
                    className={`p-4 ${
                      theme === "dark" ? "bg-[#1b1c1e]" : "bg-gray-50"
                    } rounded-lg`}
                  >
                      ...
                      <div className="flex-shrink-0">
                        ...
                        <div
                          className={`w-16 h-16 rounded-full ${
                            ...
                            vehicleData.owner_image ? "hidden" : "flex"
                          }`}
                        >
                          <User
                            className={`w-8 h-8 ${
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex justify-between">
                      ...
                      >
                        {formatDate(vehicleData.manufacturingYear)}
                      </span>
                    </div>
                  </div>
                </div>
                    ...
                    >
                      ...
                      <div className="text-right">
                        ...
                        {vehicleData.insuranceExpiry && (
                          ...
                          >
                            {
                              getExpiryStatus(vehicleData.insuranceExpiry)
                                .message
                            }
                          </div>
                        )}
                    ...
                    >
                      ...
                      <div className="text-right">
                        ...
                        {vehicleData.registrationExpiry && (
                          ...
                          >
                            {
                              getExpiryStatus(vehicleData.registrationExpiry)
                                .message
                            }
                          </div>
                        )}
                    ...
                    >
                      ...
                      <div className="text-right">
                        ...
                        {vehicleData.inspectionExpiry && (
                          ...
                          >
                            {
                              getExpiryStatus(vehicleData.inspectionExpiry)
                                .message
                            }
                          </div>
                        )}
              ...
              {vehicleData.additionalTitles &&
                vehicleData.additionalTitles.length > 0 && (
                  <div className="mb-6">
                    <h3
                      className={`text-lg font-medium ${
                        theme === "dark"
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      {vehicleData.additionalTitles.map(
                        (title, index) =>
                          title && (
                            <div
                              key={index}
                            ...
                            >
                              ...
                              {vehicleData.additionalExpiry &&
                                vehicleData.additionalExpiry[index] && (
                                  <span
                                    className={`text-xs ${
                                      theme === "dark"
                                        ? "text-gray-400"
              ...
              >
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                  ...
                  <div>
                    ...
                    >
                      {formatDate(vehicleData.updated_at)}
                    </div>
                  </div>
                  <div>
                    <span
              ...
              <div className="mt-4">
                <div
                  className={`w-full py-3 px-3 cursor-pointer xl:text-[1rem] lg:text-[0.6rem] text-center 2xl:px-4 flex justify-center items-center rounded-xl focus:outline-none ${
                    theme === "dark"
