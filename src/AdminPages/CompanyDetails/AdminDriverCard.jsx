...
function AdminDriverCards({ img, name, id, setSelectedDriverId, setOpen }) {
    const handleClick = () => {
    ...
    return (
        <motion.div 
            ...
            className={`w-full cursor-pointer ${theme === "dark" ? "border border-[#323335] bg-[#323335] rounded-xl shadow-sm" : "border-2 border-[#ECECEC] rounded-xl shadow-sm"}`}
            onClick={()=>handleClick()}
        >
