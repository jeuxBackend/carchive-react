...
function Search({ value, setValue }) {
  ...
  return (
    ...
    >
      <div
        className={`w-full py-3 px-4 flex justify-between items-center gap-3 rounded-xl focus:outline-none ${theme === "dark" ? "bg-[#323334] text-white" : "bg-white text-black"
          }`}
      >
        <motion.img
        ...
        <input
          ...
          className={`w-full border-none outline-none ${theme === "dark" ? "placeholder:text-white" : "placeholder:text-black"
            }`}
