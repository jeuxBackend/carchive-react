          ...
          <AnimatePresence>
            {open && (
              <motion.div
                ...
                className="bg-white w-[120px] p-3 px-4 absolute z-40 top-6 right-6 flex flex-col items-center gap-2 rounded-l-full rounded-br-full rounded-tr-md text-[#7587a9] shadow-lg"
              >
                <p
                  className={`${
