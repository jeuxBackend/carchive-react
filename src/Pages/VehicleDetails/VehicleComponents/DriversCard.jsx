    ...
    <>
      <motion.div
        ...
        className={`w-full rounded-xl p-3 sm:p-4 ${
          theme === "dark" ? "bg-[#323335]" : "bg-white border border-[#ececec]"
        } relative shadow-md min-h-[350px] sm:min-h-[390px]`}
      >
        {/* Header */}
        <div className="flex items-center justify-between mb-3 sm:mb-4">
          <motion.p
            ...
            className={`${
              theme === "dark" ? "text-white" : "text-black"
            } text-lg sm:text-xl lg:text-[1.3rem] font-medium`}
          >
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      <motion.p
                        ...
                        className={`${
                          theme === "dark" ? "text-white" : "text-black"
                        } font-medium text-sm lg:text-base 2xl:text-lg capitalize truncate`}
                      >
                        {driver?.user?.name}
                      </motion.p>
                      <motion.p
                        ...
                        className={`${
                          theme === "dark" ? "text-gray-400" : "text-gray-600"
                        } text-xs lg:text-sm 2xl:text-base truncate`}
                      >
                        {driver?.user?.email}
                      </motion.p>
                    </div>
