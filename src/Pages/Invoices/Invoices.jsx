                ...
                >
                    ...
                    <tbody>
                        {data.map((item, index) => (
                            ...
                            >
                                <td className={`py-6 border ${theme === "dark" ? "border-[#323335]" : "border-[#b5b5b7]"}`}>{item.startDate}</td>
                                <td className={`py-6 border ${theme === "dark" ? "border-[#323335]" : "border-[#b5b5b7]"}`}>{item.endDate}</td>
                                <td className={`py-6 border ${theme === "dark" ? "border-[#323335]" : "border-[#b5b5b7]"}`}>{item.status}</td>
                                <td className={`py-6 border ${theme === "dark" ? "border-[#323335]" : "border-[#b5b5b7]"}`}>
                                    <a href={item.document} className="text-blue-500 hover:underline">
                                        View Document
                                    </a>
                                </td>
                            </motion.tr>
