...
const Login = () => {
    ...
    const { currentUserId, setCurrentUserId, setCurrentUserCompanyId, setCurrentUserCompanyName } = useGlobalContext();
            ...
            try {
                ...
                if (response?.data) {
                    if (response?.data?.user?.userType === "Admin") {
                        ...
                        localStorage.setItem('language', response?.data?.user?.lang);
                    }
                }
